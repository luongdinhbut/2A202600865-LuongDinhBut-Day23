...
class AgentState(TypedDict, total=False):
    ...
    Scalar fields are overwritten as the workflow progresses. Trace-like fields are
    append-only so metrics and reports can inspect the full execution history.
    """
